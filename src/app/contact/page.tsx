    ...
    <div className="min-h-screen">
      ...
      <section className="pt-36 pb-16 md:pb-20 px-6">
        <div className="max-w-[1200px] mx-auto">
          <p className="text-xs text-black/55 uppercase tracking-[0.2em] mb-6">Contact</p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="bg-gray-100 border border-gray-200 rounded-xl p-8 md:p-12 text-center">
                  ...
                  <p className="text-black/65 text-sm max-w-md mx-auto leading-relaxed">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-100 border border-gray-200 rounded-xl p-6 md:p-8 space-y-8">
                <div>
                  <p className="text-xs text-black/55 uppercase tracking-widest mb-3">Address</p>
                ...
                <div>
                  <p className="text-xs text-black/55 uppercase tracking-widest mb-3">Phone</p>
                  <a href="tel:+441162257865" className="text-brand text-sm font-semibold hover:opacity-70 transition-all duration-200">
                    +44 0116 225 7865
                  </a>
                </div>
                <div>
                  <p className="text-xs text-black/55 uppercase tracking-widest mb-3">Email</p>
                ...
                <div>
                  <p className="text-xs text-black/55 uppercase tracking-widest mb-3">Response Time</p>
                  <p className="text-black/65 text-sm leading-relaxed">
