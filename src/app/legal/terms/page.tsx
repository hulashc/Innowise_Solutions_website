  ...
  return (
    <div className="min-h-screen py-24 md:py-32 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-black dark:text-white mb-8 leading-tight">Terms &amp; Conditions</h1>
        ...
        <div className="space-y-6 text-black/65 dark:text-white/65 text-sm leading-relaxed">
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">2. Our Services</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">3. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">4. Confidentiality</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">5. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">6. Termination</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">7. Governing Law</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">8. Contact</h2>
