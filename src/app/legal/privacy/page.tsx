  ...
  return (
    <div className="min-h-screen py-24 md:py-32 px-6">
      <div className="max-w-[800px] mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-black dark:text-white mb-8 leading-tight">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-black/65 dark:text-white/65 text-sm leading-relaxed">
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">3. Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">4. Your Rights</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">5. Cookies</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">6. Third-Party Links</h2>
          ...
          <section>
            <h2 className="text-black dark:text-white font-semibold text-base mb-3">7. Contact</h2>
