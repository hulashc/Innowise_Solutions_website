...
export default function ServicesPageClient() {
  return (
    <div className="min-h-screen">
      <section className="relative pt-20 md:pt-28 pb-16 md:pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10">
          ...
          <motion.p
            ...
            className="text-sm md:text-base text-black/65 dark:text-white/65 max-w-xl mb-10 md:mb-12 leading-relaxed"
          >
      ...
      <section id="cta-services" className="py-12 md:py-16 px-6">
        <div className="max-w-[1200px] mx-auto">
