...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-surface border-t border-gray-200 dark:border-border p-4 md:p-6 shadow-lg">
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <p className="text-black/65 dark:text-white/65 text-xs leading-relaxed flex-1">
