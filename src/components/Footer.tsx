    ...
    <footer className="border-t border-black/10 dark:border-white/10 py-16 px-6">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/innowisesolutions"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black/45 dark:text-white/45 hover:text-brand dark:hover:text-brand transition-colors duration-200 p-3"
              ...
              <a
                href="https://www.instagram.com/innowisesolutions"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black/45 dark:text-white/45 hover:text-brand dark:hover:text-brand transition-colors duration-200 p-3"
        ...
        <div className="mt-16 pt-6 border-t border-black/5 dark:border-white/5 text-center">
          <p className="text-black/35 dark:text-white/35 text-xs">&copy; 2012&ndash;{new Date().getFullYear()} Innowise Solutions Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
